...
hamburg_weather = (
    session.table("TASTY_BYTES.HARMONIZED.WEATHER_HAMBURG")
    .select(
        col("DATE"),
        col("DAILY_SALES"),
...
hamburg_weather_long = hamburg_weather.melt(
    "DATE", var_name="Measure", value_name="Value"
)
...
chart = (
    alt.Chart(hamburg_weather_long)
    ...
    .configure_title(fontSize=20, font="Arial")
